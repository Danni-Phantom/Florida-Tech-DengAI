...
TESTINTERCEPT = 530.53287
TESTSLOPE = -0.09696


class test_simplelinearmodel(unittest.TestCase):
    ...
    def test_simplelinearmodel(self):
        ...
        model = simplelinearmodel(predictor, 'X', dependent_variable)
        self.assertLess(model.rx2('coefficients')[0] - round(TESTINTERCEPT, 5), .00001)
        self.assertLess(model.rx2('coefficients')[1] - round(TESTSLOPE, 5), .00001)
